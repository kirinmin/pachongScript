...
while True:
    ...
    params = {
        'g_tk_new_20200303': g_tk("Q_H_L_5KNXIlpSqIaTCx5mWjKNIhNToN-RNIDJf889huvIJJGklOWtRCv4PuA"),#qqmusic_key
        'g_tk': g_tk("Q_H_L_5KNXIlpSqIaTCx5mWjKNIhNToN-RNIDJf889huvIJJGklOWtRCv4PuA"),
        'loginUin': '0',
        'hostUin': '0',
        'format': 'json',
        'inCharset': 'utf8',
        ...
        'reqtype': '2',
        'biztype': '1',
        # 'topid': '287844900',#songid
        'topid': '472051352',#songid
        'cmd': '8',
        'needmusiccrit': '0',
        'pagenum': '0',
        'pagesize': '25',
